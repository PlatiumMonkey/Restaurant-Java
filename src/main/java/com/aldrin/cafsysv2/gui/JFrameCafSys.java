...
import com.aldrin.cafsysv2.gui.dialog.JDialogStaff;
...
public class JFrameCafSys extends javax.swing.JFrame implements MouseListener {
    ...
    private void initComponents() {
        ...
        jMenuUserAccount.setIcon(new FlatSVGIcon("svg/user.svg",18,18));
        jMenuUserAccount.setText("User");
        jMenuUserAccount.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jMenuUserAccountActionPerformed(evt);
            }
        });
        jMenuManage.add(jMenuUserAccount);

        jMenuItem4.setIcon(new FlatSVGIcon("svg/user.svg",18,18));
...
//            //Invoice set input
    ...
    private void jMenuItem4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem4ActionPerformed
        JDialogStaff staff = new JDialogStaff(this,true);
