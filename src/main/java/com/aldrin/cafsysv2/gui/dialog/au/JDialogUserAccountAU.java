...
public class JDialogUserAccountAU extends javax.swing.JDialog {
    ...
    public JDialogUserAccountAU(JFrameCafSys jFrameCafSys, boolean modal, UserAccount userAccount, String title) {
        ...
        for (ComboBoxList a : this.staffDAOImpl.getList()) {
            a.setSelectedId(staffDAOImpl.getList(), String.valueOf(userAccount.getStaff().getId()), jComboBoxStaff);
        }
    ...
    private void initComponents() {
        ...
        getContentPane().add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 320, 168, 32));

        jComboBoxStaff.setPreferredSize(new java.awt.Dimension(72, 32));
        getContentPane().add(jComboBoxStaff, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 220, 250, 30));
        ...
        getContentPane().add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 220, 80, 30));

        jCheckBoxActive.setText("ACTIVE");
        getContentPane().add(jCheckBoxActive, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 260, 250, 30));
        ...
        getContentPane().add(jPanel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 291, 550, 1));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        if (this.title.equals("New")) {
            ...
            if (response == JOptionPane.YES_OPTION) {
                ...
                ComboBoxList staffId = (ComboBoxList) this.jComboBoxStaff.getSelectedItem();
                Staff staff = new Staff();
                staff.setId(staffId.getId());
                this.userAccount.setStaff(staff);
                try {
                    validatePhoto();
    ...
    private javax.swing.JComboBox<Object> jComboBoxStaff;
    ...
    private void comboBoxUserAccount() {
        ...
        staffDAOImpl.comboBoxStaff();
        jComboBoxStaff.removeAllItems();
        for (ComboBoxList a : staffDAOImpl.getList()) {
            this.jComboBoxStaff.addItem(a);
        }
    }
