...
public class JDialogUserAccount extends javax.swing.JDialog implements MouseListener {
    ...
    public DefaultTableModel tableModel = new DefaultTableModel(new Object[]{"ID", "ROLE ID", "FIRST NAME", "SURNAME", "ROLE", "USERNAME", "PASSWORD", "ACTIVE", "NAME","STAFF_ID"}, 0) {
    ...
    private void setTable() {
        ...
        //Hide col 8
        TableColumn hide9 = jTableUser.getColumnModel().getColumn(9);
        hide9.setMinWidth(0);
        hide9.setMaxWidth(0);
...
//                    }
                    if (row != -1) {
                        ...
                        String staffName = jTableUser.getValueAt(row, 8).toString();
                        Long staffId = Long.parseLong(jTableUser.getValueAt(row, 9).toString());
...
//"ID", "ROLE ID", "FIRST NAME", "SURNAME", "ROLE", "USERNAME", "PASSWORD", "ACTIVE", "STAFF"
    ...
    private void selectUserAccount() {
        ...
        for (UserAccount c : userAccountList) {
            tableModel.addRow(new Object[]{c.getId(), c.getRole().getId(), c.getFirstname(), c.getSurname(), c.getRole().getRole(), c.getUsername(), c.getPassword(), c.getActive(), c.getStaff().getName(), c.getStaff().getId()});
        }
    }
